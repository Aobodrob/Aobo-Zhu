...
if __name__ == "__main__":
    ...
    for epoch in range(Init_Epoch, UnFreeze_Epoch):
        ...
        optimizer = optim.Adam(model.parameters(), Init_lr_fit, betas=(momentum, 0.999), weight_decay=weight_decay) if optimizer_type == "adam" \
        ...
        fit_one_epoch(model_train, model, loss_history, eval_callback, optimizer, epoch, 
                      ...
                      Cuda, True, False, np.ones([num_classes], np.float32), num_classes, fp16, scaler, save_period, save_dir, local_rank)
